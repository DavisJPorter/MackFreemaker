...
public class Score_Counter : MonoBehaviour
{
	...
	void SetCountText()
    {
        CountText.text = "<color=#c0c0c0ff><size=0.25>Score:</size></color> " + Count.ToString("F0");
    }        // do not adjust the text size from 0.25 or it will no longer fit the window with the system we are using
